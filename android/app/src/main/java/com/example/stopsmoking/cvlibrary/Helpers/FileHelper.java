package com.example.stopsmoking.cvlibrary.Helpers;
...
public class FileHelper {
    ...
    private static final String FOLDER_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/capstone";
    public static final String TRAINING_PATH = FOLDER_PATH + "/training/";
    public static final String RAW_PATH = FOLDER_PATH + "/raw/";
